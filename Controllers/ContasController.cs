...
namespace Banco.MVC.Controllers
{
    public class ContasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Tipoconta,TipoModalidade,Saldo,Credito,Nome")] Conta conta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Tipoconta,TipoModalidade,Saldo,Credito,Nome")] Conta conta)
        {
            if (id != conta.Id)
            {
                return NotFound();
